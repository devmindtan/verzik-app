...
export function LoginPage({ onSuccess }: LoginPageProps) {
  ...
  const predefinedAccounts = [
    ...
    },
    {
      ...
      label: "Tenant Admin",
      description:
        "Manage tenant config, set treasury & operator manager, revoke documents.",
    ...
    },
    {
      ...
      description:
        "Manage operator lifecycle, slashing, co-sign policies, penalties.",
    ...
    },
    {
      ...
      description:
        "Register and co-sign documents. Verify & search transactions.",
    ...
    },
    {
      ...
      label: "End User",
      description:
        "Read-only access. View documents signed by operators for your wallet.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-3xl w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">Verzik</h1>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          ...
          <p className="text-slate-400 text-sm mb-6">
            Each role has distinct permissions. Treasury is a special role that
            only receives slashed funds.
          </p>
          ...
          <div className="mt-6 pt-6 border-t border-white/10 space-y-4">
            ...
            <p className="text-xs text-slate-500 text-center">
              Sign in as End User (read-only). No wallet required.
            </p>
          </div>
        </div>

        <div className="mt-6 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl text-sm text-amber-300">
          <strong>Demo:</strong> All data is in-memory and resets on refresh. No
